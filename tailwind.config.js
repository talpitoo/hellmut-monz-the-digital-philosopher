...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      spacing: {
        'section-mobile': 'calc(11 * var(--spacer-mobile))',
        'section-sm-mobile': 'calc(4 * var(--spacer-mobile))',
        'section-desktop': 'calc(11 * var(--spacer-desktop))',
        'section-sm-desktop': 'calc(4 * var(--spacer-desktop))',
        
        'spacer-mobile1': 'var(--spacer-mobile)',
        'spacer-mobile2': 'calc(2 * var(--spacer-mobile))',
        'spacer-mobile3': 'calc(3 * var(--spacer-mobile))',
        'spacer-mobile7': 'calc(7 * var(--spacer-mobile))',
        'spacer-mobile12': 'calc(12 * var(--spacer-mobile))',
        'spacer-mobile14': 'calc(14 * var(--spacer-mobile))',
        'spacer-mobile29': 'calc(29 * var(--spacer-mobile))',

        'spacer-desktop1': 'var(--spacer-desktop)',
        'spacer-desktop2': 'calc(2 * var(--spacer-desktop))',
        'spacer-desktop3': 'calc(3 * var(--spacer-desktop))',
        'spacer-desktop7': 'calc(7 * var(--spacer-desktop))',
        'spacer-desktop12': 'calc(12 * var(--spacer-desktop))',
        'spacer-desktop14': 'calc(14 * var(--spacer-desktop))',
        'spacer-desktop29': 'calc(29 * var(--spacer-desktop))',
      },
      gap: {
        'spacer-mobile2': 'calc(2 * var(--spacer-mobile))',
        'spacer-desktop2': 'calc(2 * var(--spacer-desktop))',
